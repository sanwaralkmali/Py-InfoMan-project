...
#####################  Student Data  ###################
        ...
        btn_ac_adduser = QAction(
            QIcon("/home/salah/Desktop/Py-infoman-gui-project/icon/user-profiles.png"), "Add Student", self)
        ...
        adduser_action = QAction(QIcon(
            "/home/salah/Desktop/Py-infoman-gui-project/icon/add.png"), "Insert Student", self)
        adduser_action.triggered.connect(self.insert)
        file_menu.addAction(adduser_action)

        searchuser_action = QAction(
            QIcon("/home/salah/Desktop/Py-infoman-gui-project/icon/search.png"), "Search Student", self)
        searchuser_action.triggered.connect(self.search)
        file_menu.addAction(searchuser_action)

        deluser_action = QAction(
            QIcon("/home/salah/Desktop/Py-infoman-gui-project/icon/trash.png"), "Delete Student", self)
        deluser_action.triggered.connect(self.delete)
        file_menu.addAction(deluser_action)

        rm_all_action = QAction(
            QIcon("/home/salah/Desktop/Py-infoman-gui-project/icon/criss-cross.png"), "Delete All Students", self)
